 ...
 */
const entTestHeadlineSchema = new PgSchema(
...
class EntTestHeadline extends BaseEnt(testCluster, entTestHeadlineSchema) {
  static readonly CREATE = [
    `CREATE TABLE %T(
      id bigint NOT NULL PRIMARY KEY,
 ...
 * Country
 */
const entTestCountrySchema = new PgSchema(
...
class EntTestCountry extends BaseEnt(testCluster, entTestCountrySchema) {
  static readonly CREATE = [
    `CREATE TABLE %T(
      id bigint NOT NULL PRIMARY KEY,
      name text,
