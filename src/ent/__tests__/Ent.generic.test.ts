 ...
 * Company
 */
const entTestCompanySchema = new PgSchema(
  'ent.generic"company',
  {
...
class EntTestCompany extends BaseEnt(testCluster, entTestCompanySchema) {
 ...
 * User -> Company
 */
const entTestUserSchema = new PgSchema(
  'ent.generic"user',
  {
...
class EntTestUser extends BaseEnt(testCluster, entTestUserSchema) {
  static readonly CREATE = [
    `CREATE TABLE %T(
      id bigint NOT NULL PRIMARY KEY,
 ...
 * Post -> User -> Company
 */
const entTestPostSchema = new PgSchema(
  'ent.generic"post',
  {
...
class EntTestPost extends BaseEnt(testCluster, entTestPostSchema) {
  static readonly CREATE = [
    `CREATE TABLE %T(
 ...
 */
const entTestCommentSchema = new PgSchema(
  'ent.generic"comment',
  {
...
class EntTestComment extends BaseEnt(testCluster, entTestCommentSchema) {
  static readonly CREATE = [
    `CREATE TABLE %T(
 ...
 */
const entTestLikeSchema = new PgSchema(
  'ent.generic"like',
  {
    id: { type: ID, autoInsert: "id_gen()" },
    post_id: { type: ID },
...
class EntTestLike extends BaseEnt(testCluster, entTestLikeSchema) {
  static readonly CREATE = [
    `CREATE TABLE %T(
      id bigint NOT NULL PRIMARY KEY,
      post_id bigint NOT NULL,
