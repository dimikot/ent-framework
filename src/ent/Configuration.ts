...
export class Configuration<TTable extends Table> {
  ...
  declare readonly shardAffinity: ShardAffinity<FieldOfIDType<TTable>>;
  ...
  declare readonly privacyTenantPrincipalField?: Validation<TTable>["tenantPrincipalField"];
  ...
  declare readonly privacyInferPrincipal:
    | ((
        vc: VC,
        row: Row<TTable>,
  ...
  declare readonly privacyLoad: ValidationRules<TTable>["load"];
  ...
  declare readonly privacyInsert: ValidationRules<TTable>["insert"];
  ...
  declare readonly privacyUpdate?: ValidationRules<TTable>["update"];
  /** Privacy rules checked before a row is deleted in the DB.
   * - If not defined, privacyInsert rules are used.
   * - The rules must include at least one Require() predicate. */
  declare readonly privacyDelete?: ValidationRules<TTable>["delete"];
  /** Custom field values validators run before any insert/update. */
  declare readonly validators?: ValidationRules<TTable>["validate"];
  /** Triggers run before every insert. */
  declare readonly beforeInsert?: Array<InsertTrigger<TTable>>;
  /** Triggers run before every update. */
  declare readonly beforeUpdate?: Array<
    | BeforeUpdateTrigger<TTable>
    | [DepsBuilder<TTable>, BeforeUpdateTrigger<TTable>]
  >;
  /** Triggers run before every delete. */
  declare readonly beforeDelete?: Array<DeleteTrigger<TTable>>;
